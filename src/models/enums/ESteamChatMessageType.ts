enum ESteamChatMessageType {
  JustCreated = 0, // we just created the trade offer.
  Invalid = 1,
  ...
  ClientMessage = 12, // message from us
  PartnerMessage = 13, // message from partner
  SystemMessage = 14, // system message
  Error = 15, // error message
}

export default ESteamChatMessageType;
